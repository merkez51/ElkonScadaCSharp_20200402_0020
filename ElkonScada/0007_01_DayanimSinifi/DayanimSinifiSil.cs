...
{
    public partial class DayanimSinifiSil : Form
    {

        public DayanimSinifiSil()
        {
            InitializeComponent();
        }
        ...
        {
            string sql = "DELETE FROM DayanimSinifi WHERE SiraNo=@No";
            ...
            cmd.Parameters.AddWithValue("@No", ((DayanimSinifiBeton)Application.OpenForms["DayanimSinifiBeton"]).no);
        ...
        //
        private void DayanimSinifiSil_Load(object sender, EventArgs e)
        {
            DilDegistir();
        }
