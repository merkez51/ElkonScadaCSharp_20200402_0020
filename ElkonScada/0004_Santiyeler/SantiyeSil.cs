...
namespace ElkonScada._0004_Santiyeler
{
    public partial class SantiyeSil : Form
    {
        ...
        {
            string sql = "DELETE FROM Santiyeler WHERE SiraNo=@No";
            ...
            cmd.Parameters.AddWithValue("@No", ((Santiyeler)Application.OpenForms["Santiyeler"]).no);
        ...
        //
        private void SantiyeSil_Load(object sender, EventArgs e)
        {
            DilDegistir();
        }
