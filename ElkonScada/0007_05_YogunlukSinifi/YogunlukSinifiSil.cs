...
{
    public partial class YogunlukSinifiSil : Form
    {
        public YogunlukSinifiSil()
        {
            InitializeComponent();
        }
        ...
        {
            string sql = "DELETE FROM YogunlukSinifi WHERE SiraNo=@No";
            ...
            cmd.Parameters.AddWithValue("@No", ((YogunlukSinifiBeton)Application.OpenForms["YogunlukSinifiBeton"]).no);
        ...
        //
        private void YogunlukSinifiSil_Load(object sender, EventArgs e)
        {
            DilDegistir();
        }
